    ...
    <ScrollAnimation animateIn="fadeIn" duration={1.5} animateOnce={true}>
      <div id="about" className={styles.aboutMe}>
        ...
        <div className={styles.aboutMeInfoSection}>
          <p>
            I’m a <span>dedicated full stack web developer</span> specializing
            in <span>Next.js</span> with
            <span> TypeScript</span>, <span>SCSS</span>, and{" "}
            <span>MongoDB</span>. I have experience working with{" "}
            <span>Node.js </span>
            ...
            actively seeking <span>job or internship opportunities</span> where
